...
const socials = [
  ...
  {
    name: 'Email',
    href: 'mailto:w99709475@gmail.com',
    icon: (
...
export default function Contact() {
  ...
  return (
    <section className="contact section" aria-label="Contact" ref={sectionRef}>
      <div className="contact__inner">
        <div className="reveal">
          ...
          <p className="contact__description">
            ...
            about tech and security. Feel free to reach out!
          </p>
        </div>
        ...
        <div className="contact__cta reveal reveal-delay-2">
          <a href="mailto:w99709475@gmail.com" className="contact__btn">
            Say Hello 👋
          </a>
        </div>
      </div>
